...
const NavItems = [
  ...
  },
  {
    ...
    items: [
      {
        title: "CCTV Installation & Monitoring Services",
        href: "/cctv-installation",
      },
      {
        title: "Access Control Systems Services",
        href: "/access-control-systems",
      },
      {
        title: "Alarm Systems & Intrusion Detection Services",
        href: "/alarm-systems",
      },
      {
        title: "Security System Maintenance & Support Services",
